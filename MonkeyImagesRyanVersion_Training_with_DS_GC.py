...
class MonkeyImages(tk.Frame,):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.StudyID = ['ABC']                              # 3 letter study code
        self.SessionID = ['SessionID']                      # Type of Session
        ...
        self.DiscrimStimMin = 2#0.05                           # (seconds) Minimum seconds to display Discrim Stim for before Go Cue
        self.DiscrimStimMax = 2#0.05                             # (seconds) Maxiumum seconds to display Discrim Stim for before Go Cue
        ...
        self.GoCueMin = 2#0.25                           # (seconds) Minimum seconds to display Discrim Stim for before Go Cue
        self.GoCueMax = 2#0.5                             # (seconds) Maxiumum seconds to display Discrim Stim for before Go Cue
        ...
        self.RewardDelayMin = 1#0.010                         # (seconds) Min Length of Delay before Reward (Juice) is given.
        self.RewardDelayMax = 1#0.010                         # (seconds) Max Length of Delay before Reward (Juice) is given.
...
############################################################################################################################################
    def DurationList(self):
        self.csvdict = {'Hand in Home Zone': [], 'Study ID': self.StudyID, 'Session ID': self.SessionID, 'Animal ID': self.AnimalID, 'Date': self.Date, 'Session Time': []}
            ...
            #For other new data find the AI channel 1 data for pedal
                if source_numbers_types[new_data.source_num_or_type[i]] == CONTINUOUS_TYPE and (new_data.channel[i] in self.ActiveJoystickChans
                    ...
                    if tmp_channel == 19: # Start Timestamps are inconsistent and missing some.
                        ...
                        print('asdofghiaghasiodfsdaofihsdaioghsdaiofhsdaiohsdaiofsadiosdaiodiofsajfiosdgiosahgilsadi')
