...
#
# (c) 2017 Plexon, Inc., Dallas, Texas
# www.plexon.com
#
...
class OPX_GlobalParams(Structure):
    _fields_ = [("OPXSystemType", c_int32),           # A hardware-specific OPXSTSTEM_* value (see 4 values above)
                ...
                ("clientSampleRateLimit", c_double),  # Server only sends continuous data to clients if the sample rate is this frequency of less; by default, 1000 Hz
...
class PyOPXClient:
    ...
    def set_data_format(self, data_format):
        """
        Sets the format for the data returned. Data can me formatted in terms of source number and source-relative
    ...
    def source_chan_to_linear_chan_and_type(self, source_num, source_chan):
        ...
        Args:
            source_num - Source number
            source_chan - Channel number within specific source
