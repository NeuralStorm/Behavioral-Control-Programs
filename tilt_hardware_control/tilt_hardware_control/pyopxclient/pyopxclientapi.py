    ...
    def get_global_parameters(self):
        ...
        Returns:
            global_parameters - A named tuple, with fields defined below
                .opx_system_type - hardware-specific OPXSTSTEM_* vakye
                .opx_software_version - version of OmniPlex being used, e.g. 1151 = version 1.15.1
                .opx_sdk_version - version of the Native Client API being used
                .num_sources - total number of sources available to cient
                .soruce_ids - a list of source numbers, e.g. [4, 1, 3, 6, 10, 11, ...]
                .num_spike_chans - total number of channels of SPIKE_TYPE
                .num_cont_chans - total number of channels of CONTINUOUS_TYPE
                .num_event_chans - total number of channels of EVENT_TYPE
                .num_other_chans - total number of channels of OTHER_TYPE
                .timestamp_frequency - frequency of timestamp "tkick"; currently either 40000 or 1000000, i.e. one tick = either 25 
                microseconds or 1 microsecond
                .client_sample_rate_limit - server only sends continous data to cinets if the sample rate is this frequency or less;
                by default, 1000 Hz
                .bits_per_sample - typically either 12 or 16 bits, as set in SErver options
                .minimize_client_latency - nonzerio if server "minimize Client Latency" option is enabled
        """
        ...
        Returns:
            new_data - Named tuple loaded with data:
                ...
                If timestamps_only == True:
                    ...
                    .source_num_or_type - source numbers or source types (SPIKE_TYPE or EVENT_TYPE) for each timestamp
