...
def tilt(i,task,taskinterrupt,x):
    ...
    tilt1 = np.array([1,0,0,0,0,0,0,0], dtype=np.uint8)# right slow
    tilt3 = np.array([1,1,0,0,0,0,0,0], dtype=np.uint8)# right fast
    tilt4 = np.array([0,0,1,0,0,0,0,0], dtype=np.uint8)# left slow
    tilt6 = np.array([0,1,1,0,0,0,0,0], dtype=np.uint8)# left fast
...
##    taskinterrupt.WriteDigitalLines(1,1,10.0,PyDAQmx.DAQmx_Val_GroupByChannel,punish,None,None)
    #Replaced by decoder stuff for online
##    if i%2 == 0:
##        print('punish')
##        taskinterrupt.WriteDigitalLines(1,1,10.0,PyDAQmx.DAQmx_Val_GroupByChannel,punish,None,None)
##    else:
...
if __name__ == "__main__":
    ...
    punish  = np.array([0,0,1,0,0,0,0,0], dtype=np.uint8)
    reward  = np.array([0,0,1,1,0,0,0,0], dtype=np.uint8)
    start1 = np.array([0,0,0,1,0,0,0,0], dtype=np.uint8)
    task = Task()
    taskinterrupt = Task()
...
##        taskinterrupt.WriteDigitalLines(1,1,10.0,PyDAQmx.DAQmx_Val_GroupByChannel,punish,None,None)
##
##        task.WriteDigitalLines(1,1,10.0,PyDAQmx.DAQmx_Val_GroupByChannel,start1,None,None)
##        #taskinterrupt.WriteDigitalLines(1,1,10.0,PyDAQmx.DAQmx_Val_GroupByChannel,begin,None,None)
##        
##        print('punish')
##        time.sleep(1.5)
