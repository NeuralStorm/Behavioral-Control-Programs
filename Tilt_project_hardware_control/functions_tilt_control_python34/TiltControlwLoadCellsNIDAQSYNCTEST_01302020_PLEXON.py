...
def LoadCellThread():
    ...
    with nidaqmx.Task() as task:
        #######################################################
        sheetName = 'test02132020_strobeswcells' #csm015_112019_baseline_tilt_nohaptic_loadcell #'csm015_122419_week4sci_hindlimbtilt_nohaptic_loadcell2'
        #######################################################
        with open(sheetName + '.csv','w+',newline='') as f:
            ...
            task.timing.cfg_samp_clk_timing(1000, source = "/Dev6/PFI7",active_edge = Edge.RISING, sample_mode = AcquisitionType.CONTINUOUS, samps_per_chan = 1000)
