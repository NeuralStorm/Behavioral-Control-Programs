...
def LoadCellThread():
    ...
    with nidaqmx.Task() as task, nidaqmx.Task() as taskstart:
        #######################################################
        sheetName = 'CSM005_BASELINE_TRAININGDAY1_9419'
        #######################################################
...
###     
    AutoWaterReward = True #Change this to false if you don't want automatic water rewards 
    TTLon = False
    TiltWait = False
    TiltReady = False
...
##    tiltstart.terminate()
    ...
    input('Press Enter to Start Sensors')
